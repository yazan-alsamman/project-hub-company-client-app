...
* **Showing empathy**: Being empathetic towards other community members,
  understanding that everyone has different backgrounds and experiences

* **Being collaborative**: Working together towards common goals, sharing
  knowledge and expertise, helping others learn and grow

* **Being constructive**: Providing helpful feedback, focusing on solutions
  rather than problems, being open to learning from mistakes
...
* **Harassment**: The use of sexualized language or imagery, and sexual
  attention or advances of any kind

* **Trolling**: Deliberately posting inflammatory, extraneous, or off-topic
  comments, or other disruptive behavior

* **Insulting or derogatory comments**: Personal attacks, trolling, insulting
  or derogatory comments, and public or private harassment

* **Publishing others' private information**: Publishing others' private
  information, such as a physical or email address, without explicit permission

* **Other conduct**: Other conduct which could reasonably be considered
...
[conduct@projecthub.example.com](mailto:conduct@projecthub.example.com).
...
[conduct@projecthub.example.com](mailto:conduct@projecthub.example.com). All
...
**Thank you for helping make ProjectHub a welcoming and inclusive community!**
